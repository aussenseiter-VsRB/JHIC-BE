...
func (_m *Repository) Create(ctx context.Context, b *berita.Berita) error {
	ret := _m.Called(ctx, b)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *berita.Berita) error); ok {
		r0 = rf(ctx, b)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *Repository) List(ctx context.Context) ([]berita.Berita, error) {
	ret := _m.Called(ctx)
	...
	if rf, ok := ret.Get(0).(func(context.Context) []berita.Berita); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]berita.Berita)
...
func (_m *Repository) Update(ctx context.Context, b *berita.Berita) error {
	ret := _m.Called(ctx, b)
